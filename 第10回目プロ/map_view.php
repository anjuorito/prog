...
<script src='https://www.bing.com/api/maps/mapcontrol?callback=GetMap&key=Aht_lmFWPsP11ZfKBSYKBXEV9yHiHSuO-bn_PK6Fdy0a-_KrBTDG8mOnvJq25BG3
' async defer></script>
...
function GetMap(){
    //BingMapスタート
    map = new Bmap("#myMap");
    map.startMap(35.4643, 139.6262, "load", zoom); //The place is Bellevue.
